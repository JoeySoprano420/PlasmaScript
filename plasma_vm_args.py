# plasma_vm_args.py
# PlasmaScript VECE with Function + Argument Support
...
class Compiler(Transformer):
    ...
    def func_def(self, items):
        keyword = items[0]  # Prog | Main | Func
...
# -------------------------
class Frame:
    """Represents a function call frame (scope)."""
...
if __name__ == "__main__":
    # ✅ Hello World: Prog…run form
    code1 = '''
    Prog () greeting {hello user} Print ["hello Shay!"] run
    '''
    compile_and_run(code1)

    # ✅ Alternative dialect: Main…end form
    code2 = '''
    Main () greeting {hello user} Print ["hello Shay!"] end
    '''
