# plasma_vm_nested_comprehensions.py
# PlasmaScript VECE with Nested List Comprehensions
...
if __name__ == "__main__":
    ...
    let products = [x * y for x in xs for y in ys]
    Print [products]

    let evens = [(x * y) for x in xs for y in ys if (x * y) % 2 == 0]
    Print [evens]
